...
class HotkeyTrainer():
    ...
    def checkInput(self,inputVal):
        if self.timerRunning == True:
            print("comboCount: " + str(self.comboCount))
            print(self.currQuest[self.comboCount])
            print("inputVal: " + str(inputVal))
            print("compare" + str(inputVal) + "with " + "'" + self.currQuest[self.comboCount] + "'")
